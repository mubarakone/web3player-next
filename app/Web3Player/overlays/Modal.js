...
export default function Modal(props) {
  ...
  return (
    <Transition.Root show={props.clickPlay} as={Fragment}>
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={props.cancelModal}>
        <Transition.Child
          as={Fragment}
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      <Dialog.Title as="h3" className="text-base font-semibold leading-6 text-gray-900">
                        Stake ${props.stakedAmount} to Start
                      </Dialog.Title>
                      <div className="mt-2">
